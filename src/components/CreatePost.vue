<script setup>
  ...
  const fetchComments = async () => {
    try {
      const response = await axios.get(`http://localhost:8000/blog/post/${currentPost.value.id}/comments/`);
  ...
  const submitComment = async () => {
    try {
      ...
      await axios.post(`http://localhost:8000/blog/post/${currentPost.value.id}/comments/`, comment.value);
          ...
          <aside class="col-md-3">
            <div class="card mb-4">
              <div class="card-body">
                ...
                <p class="card-text">Welcome to our blog! Explore various posts on different topics. Enjoy the content and feel free to leave your comments.</p>
              </div>
            </div>
            <div class="card">
              <div class="card-body">
